        ...
        <div className="aboutme-container">
            ...
            <div className="aboutme-right-container">
                <div className="aboutme-textbox">
                    ...
                    <p>
                        My name is Cameron Barfuss, and I am a passionate programmer driven by curiosity and a love for creating. From an early age, I discovered coding as a powerful way to transform ideas into reality and share them with the world.
                    </p>
                    <p>
